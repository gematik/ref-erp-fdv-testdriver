...
@AllArgsConstructor
public class PostEUAccessAuthorization implements PatientRequests<EUAccessAuthorization> {
  ...
  public void finalizeRequest(HttpRequestInfo rb) {
    ...
    rb.setParameters("country", country);
    rb.setParameters("accessCode", accessCode);
  }
}
