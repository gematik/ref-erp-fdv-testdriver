...
public class TestFdVFactory extends ConfiguredFactory {

  public static MyConfigurationFactory loadConfig(String filePath) {
    return ConfigurationReader.forPrimSysConfiguration()
        .configFile(Path.of(filePath))
        .wrappedBy(MyConfigurationFactory::new);
  }
}
